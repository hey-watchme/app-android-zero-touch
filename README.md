...
長期記憶まわりの判断基準は、次の 2 本に整理する。

- **現在の作業引き継ぎ**: `docs/amical-longterm-memory-handoff.md`
- **長期記憶パイプラインの設計正本**: `docs/knowledge-pipeline-v2.md`
...
※ コードベースには旧 `pending -> batch grouping` モデルや stateful 実験の痕跡が一部残っていますが、現行判断は `docs/amical-longterm-memory-handoff.md` と `docs/knowledge-pipeline-v2.md` を基準に進めます。
...
└── docs/
    ├── README.md                # ドキュメント入口
    ├── knowledge-pipeline-v2.md # 長期記憶パイプラインの設計正本
...
- 長期記憶パイプライン設計: `docs/knowledge-pipeline-v2.md`
- 現在の作業引き継ぎ: `docs/amical-longterm-memory-handoff.md`
